...
function setInfo() {
    fields['firstname'] = document.getElementByName('firstname').value;
    fields['lastname'] = document.getElementByName('lastname').value;
    fields['age'] = document.getElementByName('age').value;
